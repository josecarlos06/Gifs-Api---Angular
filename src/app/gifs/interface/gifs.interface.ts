...
export class Convert {
    public static toGifsInterface(json: string): GifsInterface {
        return cast(JSON.parse(json), r("GifsInterface"));
    }

    public static gifsInterfaceToJson(value: GifsInterface): string {
        return JSON.stringify(uncast(value, r("GifsInterface")), null, 2);
    }
}
